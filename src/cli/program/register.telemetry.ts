...
export function registerTelemetryCommand(program: Command) {
  ...
  cmd
    ...
    .action(() => {
      ...
      const envDisabled =
        ...
        process.env.ANIMCLAW_TELEMETRY_DISABLED === "1" ||
  ...
  cmd
    ...
    .action(() => {
      ...
      console.log("You can re-enable it anytime with: npx animclaw telemetry enable");
    });
  ...
  cmd
    ...
    .action(() => {
      ...
      console.log("Telemetry has been enabled. Thank you for helping improve AnimClaw!");
    });
  ...
  privacyCmd
    ...
    .action(() => {
      ...
      console.log("Re-enable anytime with: npx animclaw telemetry privacy on");
    });
}
