...
const EXAMPLES = [
  ["openclaw start --web-port 4200", "Start the managed web runtime without replacing assets."],
  ["openclaw update", "Refresh the managed web runtime and enforce major upgrade gates."],
  ["openclaw stop --web-port 4200", "Stop only the managed web runtime on a specific port."],
