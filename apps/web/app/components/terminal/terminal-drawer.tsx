...
function terminalTheme(): ITheme {
  ...
  const background = rootStyles.getPropertyValue("--color-bg").trim() || (isDark ? "#1e1e2e" : "#eff1f5");
  const foreground = rootStyles.getPropertyValue("--color-text").trim() || (isDark ? "#cdd6f4" : "#4c4f69");
  ...
  /* Catppuccin Latte terminal palette */
  return {
    background,
    foreground,
    cursor: "#1e66f5",
