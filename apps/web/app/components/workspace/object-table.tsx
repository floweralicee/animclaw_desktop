...
type ObjectTableProps = {
	...
	/** Generate images/video for this entry (sends prompt to chat). */
	onGenerateEntry?: (entry: EntryRow) => void;
};
	...
	// Row actions
		...
		(_row: EntryRow): RowAction<EntryRow>[] => {
			...
			if (onGenerateEntry) {
				actions.push({
					label: "Generate",
					onClick: (r) => onGenerateEntry(r),
					icon: <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14.5 4h-5L7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3l-2.5-3Z" /><circle cx="12" cy="13" r="3" /></svg>,
				});
			}
			actions.push({
				label: "Delete",
		...
		[onEntryClick, handleDeleteEntry, onGenerateEntry],
	);
